...
public class JdbcCharacterDaoTests extends BaseDaoTests{
    ...
    private final Character CHAR_1 = generateCharacter(1, "a", "a", "a", "a", 1,1);
    private final Character CHAR_2 = generateCharacter(2, "b", "b", "b", "b", 1,2);
    private final Character CHAR_3 = generateCharacter(3, "c", "c", "c", "c", 1,3);
    private final Character CHAR_4 = generateCharacter(4, "d", "d", "d", "d", 1,4);

    private final Character CHAR_9 = generateCharacter(9, "i", "i", "i", "i", 2,1);
    private final Character CHAR_10 = generateCharacter(10, "j", "j", "j", "j", 2,2);
    private final Character CHAR_11 = generateCharacter(11, "k", "k", "k", "k", 2,3);
    private final Character CHAR_12 = generateCharacter(12, "l", "l", "l", "l", 2,4);
    ...
    public void create_character() {
        Character character = generateCharacter( -1, "name", "race", "description", "Rogue",2,5);
    ...
    private Character generateCharacter(int id, String name, String race, String description, String characterClass, int monsterId, int userId) {
