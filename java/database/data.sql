...
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id, flagged_inappropriate, image_id)
	...
	'Learned the magic of ocean creatures and utilizes that power in his fighting style. Grew up working for his fathers criminal organization, drawing in merchant ships with Siren collaborators and salvaging the goods from the ensuing wreckage. He hass been recovering from a bad personality ever since.',
	 18,17,15,12,13,14, 6,1, 'flagged', 2); --id 1
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id, image_id)
	VALUES ('Ba', 'Wizard', 'Dwarf', 'Eats rocks. Tamed a basalisk to make more rocks to eat.', 14,18,16,15,12,13, 6,2, 3); --id 2
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id)
	VALUES ('Lyfet', 'Rogue', 'Elf', 'Do not trust him', 13,14,18,16,15,12, 6,3); --id 3
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id, image_id)
	...
	12,13,14,18,16,15, 6,4, 4); --id 4
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id)
	VALUES ('Teg', 'Fighter', 'Elf', 'Floats', 15,12,13,14,18,16, 6,5); --id 5
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id)
	VALUES ('Zic', 'Paladin', 'Dwarf', 'Unicorn Blood', 16,15,12,13,14,18, 6,6); --id 6
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id, image_id)
	VALUES ('Fig', 'Fighter', 'Gnome', 'Loves eating', 10,10,10,10,10,10, 6,7, 5); --id 7
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id, image_id)
...
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id)
	...
	10,10,10,10,10,10, 6,9); --id 9
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id, image_id)
	VALUES ('Kay', 'Monk', 'Human', 'She punches people.', 10,10,10,10,10,10, 4,9, 9); --id 10
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id, image_id)
	VALUES ('Mil', 'Barbarian', 'Elf', 'He yells at people.', 10,10,10,10,10,10, 4,6, 8); --id 11
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id, image_id)
	VALUES ('Bee', 'Fighter', 'Dwarf', 'He stabs people.', 10,10,10,10,10,10, 4,3, 7); --id 12
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id, image_id)
	VALUES ('Al', 'Wizard', 'Dragon Born', 'He curses people.', 10,10,10,10,10,10, 4,2, 10); --id 13
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id, flagged_inappropriate)
	VALUES ('Tim', 'Wizard', 'Human', 'He does magic against people.', 10,10,10,10,10,10, 6,7, 'flagged'); --id 14
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id, flagged_inappropriate)
	VALUES ('George', 'Bard', 'Halfling', 'His music is awful.', 10,10,10,10,10,10, 6,1, 'flagged'); --id 15
	
	
	
INSERT INTO party (character_1, character_2, character_3, character_4) VALUES (1,2,3,4); --id 1 monster 6
INSERT INTO party (character_1, character_2, character_3, character_4) VALUES (2,4,5,7); --id 2 monster 6
INSERT INTO party (character_1, character_2, character_3, character_4) VALUES (3,4,5,7); --id 3 monster 6
INSERT INTO party (character_1, character_2, character_3, character_4) VALUES (10,11,12,13); --id 4 monster 4



INSERT INTO users_party (user_id,party_id) VALUES (4,1); --monster 6
INSERT INTO users_party (user_id,party_id) VALUES (5,2); --monster 6
INSERT INTO users_party (user_id,party_id) VALUES (6,1); --monster 6
INSERT INTO users_party (user_id,party_id) VALUES (7,3); --monster 6
INSERT INTO users_party (user_id,party_id) VALUES (8,3); --monster 6
INSERT INTO users_party (user_id,party_id) VALUES (9,1); --monster 6
INSERT INTO users_party (user_id,party_id) VALUES (3,1); --monster 6
INSERT INTO users_party (user_id,party_id) VALUES (1,4); --monster 4
