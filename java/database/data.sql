...
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id, image_id)
	VALUES ('Toblerone', 'Rogue', 'Dwarf', 'Builds machines to fight for him. Legally distinct from any Swedish citizen vigilantes you may be thinking of.', 10,10,10,10,10,10, 4,8, 6); --id 8
INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id)
	VALUES ('Reinhardt', 'Monk', 'Elf', 'A knight reaching the end of a very long life. While still committed to protecting the royal family, he has begun to spend time working with the citizens of the Moonsong Kingdom to ensure those without power are not forgotten.', 10,10,10,10,10,10, 4,9); --id 9
	INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id)
	VALUES ('Kay', 'Monk', 'Human', 'She punches people.', 10,10,10,10,10,10, 3,9); --id 10
	INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id)
	VALUES ('Mil', 'Barbarian', 'Elf', 'He yells at people.', 10,10,10,10,10,10, 3,5); --id 11
	INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id)
	VALUES ('Bee', 'Fighter', 'Dwarf', 'He stabs people.', 10,10,10,10,10,10, 3,3); --id 12
	INSERT INTO character (name, char_class, race, description, strength, dexterity, constitution, intelligence, wisdom, charisma, monster_id, user_id)
